...
int main() {
    ...
    for (fuzz = 0; fuzz < 5; fuzz++) {
        ...
        int numCoinsTestsPassed = 0;
        int numCoinsTestsFailed = 0;
        
        int numActionsTestsPassed = 0;
        int numActionsTestsFailed = 0;
        
        int numCardsTestsPassed = 0;
        int numCardsTestsFailed = 0;
        ...
        */
        ...
        // print out total test results
        printf("*** Fuzz: %d ***\n", fuzz);
        printf("total coins tests passed: %d\n", numCoinsTestsPassed);
        printf("total coins tests failed: %d\n\n", numCoinsTestsFailed);
        
        printf("total actions tests passed: %d\n", numActionsTestsPassed);
        printf("total actions tests failed: %d\n\n", numActionsTestsFailed);
        
        printf("total cards tests passed: %d\n", numCardsTestsPassed);
        printf("total cards tests failed: %d\n\n", numCardsTestsFailed);
    }
