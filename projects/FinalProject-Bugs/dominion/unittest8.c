...
int main() {
    ...
    int i;
    int handPos = 0, choice1 = 1, choice2 = 0, choice3 = 0;
	int card = baron;
    int seed = 1000;
    int numPlayers = 2;
    int currentPlayer = 0;
	int numCards = 0;
    int numCoinsOld = 0, numCoinsNew = 0;
	...
	*/
	...
	numCoinsOld = testG.coins;	// Original num coins
	...
	testG.phase = 2;		// Make sure phase is > 0
	testG.numActions = 2; 	// Make sure numActions > 0

	playCard(handPos, choice1, choice2, choice3, &testG);	// Run playCard
	...
	printf("actual = %d\n", numCoinsNew);
	printf("assert = %d\n\n", myAssert(numCoinsOld + 4, numCoinsNew));
